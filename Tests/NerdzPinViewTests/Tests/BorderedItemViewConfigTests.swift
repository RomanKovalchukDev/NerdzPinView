//
//  BorderedItemViewConfigTests.swift
//  NerdzPinView
//
...
@MainActor
@Suite("Bordered Item View Config")
struct BorderedItemViewConfigTests {
    ...
    struct DefaultsTests {
        ...
        func testLayoutDefaultValueShouldMatchDocumentedDefaults() {
            // Act
            let layout = BorderedItemView.LayoutConfig.defaultValue

            // Assert
            #expect(layout.cornerRadius == 8)
            #expect(layout.cursorWidth == 1)
        }
    }
}
...
private enum TestData {
    ...
    static func configWithOverrides() -> BorderedItemView.AppearanceConfig {
        BorderedItemView.AppearanceConfig(
    ...
    static func configWithoutOverrides() -> BorderedItemView.AppearanceConfig {
        BorderedItemView.AppearanceConfig(
            defaultBackgroundColor: defaultColor,
