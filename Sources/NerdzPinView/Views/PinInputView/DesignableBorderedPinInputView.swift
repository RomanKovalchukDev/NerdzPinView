//
//  DesignableBorderedPinInputView.swift
//  NerdzPinView
//
...
/// A ready to use bordered pin input that wraps and pre-styles a ``PinCodeInputView``.
///
...
/// bordered appearance. Subclass it to customize the preset styling, or use
/// ``NerdzBorderedPinView`` to embed it in SwiftUI.
@MainActor
open class DesignableBorderedPinInputView: UIView {
    ...
    /// The backing pin input, pre-configured with the default bordered styling.
