...
/// A SwiftUI wrapper around ``DesignableBorderedPinInputView`` for bordered pin entry.
///
...
public struct NerdzBorderedPinView: UIViewRepresentable {
    ...
    /// - Returns: A configured ``DesignableBorderedPinInputView``.
    ...
    public func updateUIView(_ uiView: DesignableBorderedPinInputView, context: Context) {
